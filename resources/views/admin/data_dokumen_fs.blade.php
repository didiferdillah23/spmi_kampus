...
<div class="container-fluid">
    ...
    <br>
    <form class="form-inline" action="/admin/lihatt/{{ $jenis_dok }}/cari" method="get">
        <div class="form-group mr-sm-3">
            <input type="text" name="kode" class="form-control" id="kode" placeholder="Cari kode">
        </div>
        <button type="submit" class="btn btn-primary">Cari</button>
        <a href="/admin/lihatt/{{ $jenis_dok }}" class="btn btn-warning ml-1">Refresh</a>
    </form>
    <br>
    <!--  -->
    <table class="table table-striped">
        ...
        <?php
            ...
            <tr>
                ...
                <td>{{ $d->kategori }}</td>
                <td>{{ $d->kode }}</td>
                <td><a href="/admin/download_dok_mutu/{{ $d->nama_file }}" class="badge badge-success p-2">Download</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
